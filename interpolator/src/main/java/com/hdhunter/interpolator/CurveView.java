...
public class CurveView extends View {
    ...
    private void drawHorizontalGrids(Canvas canvas) {
        for (int i = 0; i < xValues.length; ++i) {
            canvas.drawLine(0, mHeightMargin + xValues[i] * mUnitHeight, mWidth, mHeightMargin + xValues[i] * mUnitHeight,
                    mGridPaint);
        }
    }
    ...
    private void drawVerticalGrids(Canvas canvas) {
        for (int i = 0; i < xValues.length; ++i) {
            canvas.drawLine(xValues[i] * mWidth, 0, xValues[i] * mWidth, mHeight, mGridPaint);
        }
    }
